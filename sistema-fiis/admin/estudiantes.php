...
$sql = "SELECT e.id_estudiante, u.nombre_usuario, e.codigo_universitario, e.telefono, e.direccion, e.fecha_nacimiento, e.fecha_registro, c.nombre_carrera
        FROM estudiantes e
...
<body>
    ...
    <div class="main-content">
        <div class="container">
            <div class="header">
                <h1>ESTUDIANTES</h1>
                <button class="add-button">+ Agregar estudiante</button>
            </div>
            <div class="controls">
                <div>
                    Mostrar 
