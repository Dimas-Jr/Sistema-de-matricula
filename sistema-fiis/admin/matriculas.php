...
$sql = "SELECT m.id_matricula, e.codigo_universitario, c.nombre_curso, m.fecha_matricula, m.estado_matricula 
        FROM matriculas m 
...
<body>
    ...
    <div class="main-content">
        <div class="container">
            <div class="header">
                <h1>MATRÍCULAS</h1>
                <button class="add-button">+ Agregar matrícula</button>
            </div>
            <div class="controls">
                <div>
                    Mostrar 
                ...
                <tbody>
                    ...
                    if (mysqli_num_rows($resultado) > 0) {
                        ...
                        while($fila = mysqli_fetch_assoc($resultado)) {
                            ...
                            echo "<td>" . $fila['codigo_universitario'] . "</td>";
                        ...
                        echo "<tr><td colspan='6'>No se encontraron matrículas</td></tr>";
                    }
                    ?>
                </tbody>
            </table>
            <div class="pagination">
                <div>Mostrando registros del 1 al <?php echo mysqli_num_rows($resultado); ?> de un total de <?php echo mysqli_num_rows($resultado); ?></div>
                <div>
