...
$sql= "SELECT id_docente, nombre_usuario, correo, telefono, direccion, fecha_nacimiento, especialidad, activo FROM docentes";
...
<body>
    ...
    <div class="main-content">
        <div class="container">
            <div class="header">
                <h1>DOCENTES</h1>
                <button class="add-button">+ Agregar docente</button>
            </div>
            <div class="controls">
                <div>
                    Mostrar 
