...
$sql = "SELECT h.id_horario, c.nombre_curso, d.nombre_usuario AS nombre_docente, h.dia_semana, h.hora_inicio, h.hora_fin 
        FROM horarios h 
...
<body>
    ...
    <div class="main-content">
        <div class="container">
            <div class="header">
                <h1>HORARIOS</h1>
                <button class="add-button">+ Agregar horario</button>
            </div>
            <div class="controls">
                <div>
                    Mostrar 
            ...
            <table>
                ...
                <tbody>
                    ...
                    if (mysqli_num_rows($resultado) > 0) {
                        ...
                        echo "<tr><td colspan='7'>No se encontraron horarios</td></tr>";
                    }
                    ?>
                </tbody>
            </table>
