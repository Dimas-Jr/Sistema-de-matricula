...
$sql = "SELECT c.id_curso, c.codigo_curso, c.nombre_curso, c.descripcion, c.creditos, c.ciclo, c.cupos, u.nombre_usuario AS docente, ca.nombre_carrera
        FROM cursos c
        JOIN docentes u ON c.id_docente = u.id_docente
...
<body>
    ...
    <div class="main-content">
        <div class="container">
            <div class="header">
                <h1>CURSOS</h1>
                <button class="add-button">+ Agregar curso</button>
            </div>
            <div class="controls">
                <div>
                    Mostrar 
            ...
            <table>
                ...
                <tbody>
                    ...
                    if (mysqli_num_rows($resultado) > 0) {
                        ...
                        echo "<tr><td colspan='10'>No se encontraron cursos.</td></tr>";
                    }
                    ?>
                </tbody>
            </table>
